    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="relative overflow-visible" id="nav-notifications-btn">
          ...
          {unreadCount > 0 && (
            <Badge variant="destructive" className="pointer-events-none absolute top-0 right-0 translate-x-1/3 -translate-y-1/3 min-w-[18px] h-[18px] sm:min-w-[20px] sm:h-[20px] flex items-center justify-center px-1 py-0 text-[10px] sm:text-[11px] rounded-full leading-none font-bold">
