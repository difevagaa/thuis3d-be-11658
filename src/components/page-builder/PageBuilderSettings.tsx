  ...
  return (
    <div className="p-4 space-y-4">
      <Tabs defaultValue="general" className="w-full">
        ...
        {/* RESPONSIVE TAB - MOBILE ADAPTATION OPTIONS */}
        <TabsContent value="responsive" className="space-y-4 mt-4">
          <Accordion type="multiple" defaultValue={['mobile']}>
            ...
            <AccordionItem value="mobile">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Ocultar en móvil</Label>
                  <Switch
                    checked={section.styles?.mobileHidden || false}
                    onCheckedChange={(checked) => handleStyleChange('mobileHidden', checked)}
                  />
                </div>

                <div className="space-y-2">
                  <Label className="text-xs">Padding móvil: {section.styles?.mobilePadding || 16}px</Label>
                  <Slider
                    value={[section.styles?.mobilePadding || 16]}
                    onValueChange={([value]) => handleStyleChange('mobilePadding', value)}
                    min={0}
                    max={60}
                    step={4}
                  />
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Margen superior móvil: {section.styles?.mobileMarginTop || 0}px</Label>
                  <Slider
                    value={[section.styles?.mobileMarginTop || 0]}
                    onValueChange={([value]) => handleStyleChange('mobileMarginTop', value)}
                    min={0}
                    max={60}
                    step={4}
                  />
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Margen inferior móvil: {section.styles?.mobileMarginBottom || 0}px</Label>
                  <Slider
                    value={[section.styles?.mobileMarginBottom || 0]}
                    onValueChange={([value]) => handleStyleChange('mobileMarginBottom', value)}
                    min={0}
                    max={60}
                    step={4}
                  />
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Tamaño de fuente móvil: {section.styles?.mobileFontSize || 14}px</Label>
                  <Slider
                    value={[section.styles?.mobileFontSize || 14]}
                    onValueChange={([value]) => handleStyleChange('mobileFontSize', value)}
                    min={10}
                    max={32}
                    step={1}
                  />
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Alineación móvil</Label>
                  <Select
                    value={section.styles?.mobileTextAlign || 'inherit'}
                    onValueChange={(value) => handleStyleChange('mobileTextAlign', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Altura móvil</Label>
                  <Input
                    value={section.styles?.mobileHeight || ''}
                    onChange={(e) => handleStyleChange('mobileHeight', e.target.value)}
                    placeholder="ej. 300px, 50vh, auto"
                  />
                </div>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="tablet">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Ocultar en tablet</Label>
                  <Switch
                    checked={section.styles?.tabletHidden || false}
                    onCheckedChange={(checked) => handleStyleChange('tabletHidden', checked)}
                  />
                </div>

                <div className="space-y-2">
                  <Label className="text-xs">Padding tablet: {section.styles?.tabletPadding || 24}px</Label>
                  <Slider
                    value={[section.styles?.tabletPadding || 24]}
                    onValueChange={([value]) => handleStyleChange('tabletPadding', value)}
                    min={0}
                    max={80}
                    step={4}
                  />
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Tamaño de fuente tablet: {section.styles?.tabletFontSize || 15}px</Label>
                  <Slider
                    value={[section.styles?.tabletFontSize || 15]}
                    onValueChange={([value]) => handleStyleChange('tabletFontSize', value)}
                    min={10}
                    max={48}
                    step={1}
                  />
            ...
            <AccordionItem value="desktop">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Ocultar en desktop</Label>
                  <Switch
                    checked={section.styles?.desktopHidden || false}
                    onCheckedChange={(checked) => handleStyleChange('desktopHidden', checked)}
                  />
                </div>

                <div className="space-y-2">
                  <Label className="text-xs">Ancho máximo contenedor</Label>
                  <Select
                    value={section.styles?.containerWidth || 'full'}
                    onValueChange={(value) => handleStyleChange('containerWidth', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      ...
                      <SelectItem value="xs">Extra pequeño (480px)</SelectItem>
                      ...
                      <SelectItem value="2xl">XXL (1536px)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </AccordionContent>
        ...
        {/* ADVANCED TAB - ADVANCED STYLING & EFFECTS */}
        <TabsContent value="advanced" className="space-y-4 mt-4">
          <Accordion type="multiple" defaultValue={['borders']}>
            ...
            <AccordionItem value="borders">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="space-y-2">
                  <Label className="text-xs">Ancho de borde: {section.styles?.borderWidth || 0}px</Label>
                  <Slider
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      type="color"
                      value={section.styles?.borderColor || '#000000'}
            ...
            <AccordionItem value="effects">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="space-y-2">
                  <Label className="text-xs">Opacidad: {Math.round((section.styles?.opacity || 1) * 100)}%</Label>
                  <Slider
                    value={[section.styles?.opacity || 1]}
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Posición de imagen de fondo</Label>
                  <Select
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Tamaño de imagen de fondo</Label>
                  <Select
            ...
            <AccordionItem value="layout">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={section.styles?.position || 'relative'}
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Z-Index: {section.styles?.zIndex || 0}</Label>
                  <Slider
                    value={[section.styles?.zIndex || 0]}
                ...
                <div className="space-y-2">
                  <Label className="text-xs">Desbordamiento</Label>
                  <Select
                    value={section.styles?.overflow || 'visible'}
            ...
            <AccordionItem value="animation">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="space-y-2">
                  <Label className="text-xs">Efecto de entrada</Label>
                  <Select
                    value={section.settings?.animation || 'none'}
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Efecto parallax</Label>
                  <Switch
                    checked={section.settings?.parallax || false}
                    onCheckedChange={(checked) => handleSettingsChange('parallax', checked)}
                  />
                </div>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="links">
              ...
              <AccordionContent className="space-y-4 pt-4">
                <div className="space-y-2">
                  <Label className="text-xs">Target de enlace</Label>
                  <Select
                    value={section.settings?.linkTarget || '_self'}
                    onValueChange={(value) => handleSettingsChange('linkTarget', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="flex items-center justify-between">
                  <Label className="text-xs">Rel nofollow</Label>
                  <Switch
                    checked={section.settings?.linkNofollow || false}
                    onCheckedChange={(checked) => handleSettingsChange('linkNofollow', checked)}
                  />
                </div>
              </AccordionContent>
            </AccordionItem>
