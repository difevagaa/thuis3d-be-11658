...
export const adminMenuItems: AdminMenuSection[] = [
  ...
  // ─── SALES & ORDERS (core daily operations) ───
  {
  ...
  // ─── COMMUNICATION ───
  {
    ...
    items: [
      ...
      { icon: null, label: "Reseñas de Clientes", url: "/admin/reviews", color: "text-yellow-700", bgColor: "bg-yellow-100 hover:bg-yellow-200 border-yellow-300" },
  ...
  // ─── CONTENT MANAGEMENT ───
  {
    ...
    items: [
      ...
      { icon: null, label: "Gestión de Contenido", url: "/admin/contenido", color: "text-purple-700", bgColor: "bg-purple-100 hover:bg-purple-200 border-purple-300" },
      { icon: null, label: "Páginas Estáticas", url: "/admin/pages", color: "text-blue-700", bgColor: "bg-blue-100 hover:bg-blue-200 border-blue-300" },
      { icon: null, label: "Blog", url: "/admin/blog", color: "text-cyan-700", bgColor: "bg-cyan-100 hover:bg-cyan-200 border-cyan-300" },
      { icon: null, label: "Galería de Imágenes", url: "/admin/galeria", color: "text-teal-700", bgColor: "bg-teal-100 hover:bg-teal-200 border-teal-300" },
    ],
  },
  // ─── 3D CALCULATOR (advanced/technical) ───
  {
    ...
    items: [
      ...
      { icon: null, label: "Tests de Calibración", url: "/admin/calibracion", color: "text-fuchsia-700", bgColor: "bg-fuchsia-100 hover:bg-fuchsia-200 border-fuchsia-300" },
      { icon: null, label: "Perfiles de Calibración", url: "/admin/perfiles-calibracion", color: "text-indigo-700", bgColor: "bg-indigo-100 hover:bg-indigo-200 border-indigo-300" },
      { icon: null, label: "Ajustes de Precisión", url: "/admin/precision-calculadora", color: "text-blue-700", bgColor: "bg-blue-100 hover:bg-blue-200 border-blue-300" },
      { icon: null, label: "Detección de Soportes", url: "/admin/deteccion-soportes", color: "text-sky-700", bgColor: "bg-sky-100 hover:bg-sky-200 border-sky-300" },
  ...
  // ─── STORE SETTINGS (payment, taxes, shipping) ───
  {
    ...
    items: [
      ...
      { icon: null, label: "Envíos y Logística", url: "/admin/gestion-envios", color: "text-orange-700", bgColor: "bg-orange-100 hover:bg-orange-200 border-orange-300" },
      { icon: null, label: "Páginas Legales", url: "/admin/paginas-legales", color: "text-slate-700", bgColor: "bg-slate-100 hover:bg-slate-200 border-slate-300" },
    ],
  },
  // ─── SYSTEM ADMIN (advanced config) ───
  {
    title: "⚙️ Sistema y Datos",
    icon: null,
