...
const Products = () => {
  ...
  return (
    <div className="container mx-auto px-3 md:px-4 py-4 md:py-6 lg:py-8 mt-2">
      <div className="flex items-center gap-2 mb-3 md:mb-4 lg:mb-6">
        <Package className="h-5 w-5 md:h-8 md:w-8 text-primary flex-shrink-0" />
        <h1 className="text-lg md:text-2xl lg:text-3xl font-bold leading-tight">{t('title')}</h1>
      </div>
